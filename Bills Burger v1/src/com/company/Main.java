...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        addition[3] = new Addition("mayonnaise",0.1);
            ...
            do {
                ...
                switch (input) {
                    ...
                    case 3 -> {
                        ...
                        System.out.println(healthyHamburger.getName() + " has 2 addition as a default " +
                                healthyHamburger.getAddition1().getName() + " - " + healthyHamburger.getAddition1().getPrice() +
                                "$" + " & " + healthyHamburger.getAddition2().getName() + " - " + healthyHamburger.getAddition1().getPrice() +
                                "$" + " but if you want you can add 4 additional brand as an extra");
                        while (counter < 4) {
                            System.out.println((counter + 1) + ". addition: ");
                            additionSelector(addition);
                            System.out.println("Please type your choice: ");
